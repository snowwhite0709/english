...
public class SentenceButtonPanel extends JPanel implements ActionListener{
	 ...
	 * Create the panel.
	 */
	public SentenceButtonPanel(JPanel panelCenter, CardLayout layoutCenter, JPanel panelSub, CardLayout layoutSub, ArrayList<QA> list, ArrayList<String> selfAnswerList, int count) {
